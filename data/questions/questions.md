# VoxCité — Questions de positionnement
...
- **phase** : deep
- **weight** : 1.0
- **calibration** : D'accord → conservateur (ordre, responsabilité) / Pas d'accord → progressiste (anonymat, vie privée). Question qui fait écho à la réflexion fondatrice de VoxCité.
...
### Questions sensibles
Certaines questions (Q4, Q25, Q28, Q30) touchent des sujets où l'autocensure est forte. La formulation a été choisie pour être modérée tout en restant discriminante. Le format anonyme de VoxCité est un atout majeur ici.
